    ...
    <div id="wrapper">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                ...
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    <!-- Cart Area -->
                                    <div class="cart">
                                        <a href="#" id="header-cart-btn" target="_blank">쉬운 코드를 지향해요</a>
                ...
                <div class="container h-100">
                    <div class="row h-100">
                        <div class="col-12 d-md-flex justify-content-between">
                                ...
                                <nav class="navbar navbar-expand-lg align-items-start">
                                    ...
                                    <div class="collapse navbar-collapse align-items-start collapse" id="karl-navbar">
                                        <ul class="navbar-nav animated" id="nav">
                                            <li class="nav-item active"><a class="nav-link" href="https://test.snong.com/2024/CI/public/">Home</a></li>
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="#" id="karlDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
                                                <div class="dropdown-menu" aria-labelledby="karlDropdown">
                                                    <a class="dropdown-item" href="index.html">표준단어 생성 프로그램</a>
                                                    <a class="dropdown-item" href="shop.html">오픈API 모음집</a>
                                                    <a class="dropdown-item" href="product-details.html">개인 페이지</a>
                                                    <a class="dropdown-item" href="cart.html">개인 블로그</a>
                            ...
                            <!-- Help Line -->
                            <div class="help-line">
                                <a href="tel:+346573556778"><i class="ti-headphone-alt"></i> +10 8630 9414</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="top-discount-area d-md-flex align-items-center">
            ...
            <div class="single-discount-area">
                <h5>표준단어를 만들래요</h5>
                <h6><a href="#">다른 세계로 이동해요</a></h6>
            </div>
            <!-- Single Discount Area -->
            <div class="single-discount-area">
                <h5>snong이 만드는 여러 기능을 구경할래요.</h5>
                <h6>진심으로 환영해요</h6>
            </div>
            <!-- Single Discount Area -->
            <div class="single-discount-area">
                <h5>snong이 작성하는 블로그를 구경할래요.</h5>
                <h6>부끄럽지만 공개할게요</h6>
            </div>
        </section>
        ...
        <section class="welcome_area">
            <div class="welcome_slides owl-carousel">
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(img/bg-img/dictionaryapi.png);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h5 data-animation="bounceInDown" data-delay="0" data-duration="500ms">* 표준단어 만드는 과정이 궁금하신가요?</h5>
                                    <h2 data-animation="fadeInUp" data-delay="500ms" data-duration="500ms">만들러 가기</h2>
