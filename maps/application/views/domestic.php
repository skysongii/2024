        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="#!">메인으로</a></li>
      ...
      <div class="modal-body">
        <form>
          <div class="mb-3">
            ...
            <p id="danger-geocode" class="text-danger" style="display:none;">주소를 정확하게 입력하세요.</p>
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="start-date">
          </div>
          <div class="mb-3">
...
<div class="modal fade" id="update-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <script type="module" src="../../assets/js/insert-btn-chk-module.js"></script>
